...
- **Classes and Components**: Use PascalCase (e.g., `UserService`, `BibleRepository`)
- **Constants**: Use UPPER_SNAKE_CASE (e.g., `MAX_RETRY_COUNT`)
- **Database Fields**: Use snake_case (e.g., `user_id`, `chapter_number`)
- **Files**: Use kebab-case for CSS modules, camelCase for TypeScript

### String Formatting
- Use double quotes for strings: `"Hello World"`
- Use template literals for string interpolation: `\`Hello \${name}\``
- Use single quotes only when needed to avoid escaping
