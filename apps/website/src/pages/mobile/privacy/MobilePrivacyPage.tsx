  ...
  return (
    <>
      ...
      <div
        ...
        data-testid="mobile-privacy-page"
      >
        {/* Hero Section */}
        <div
          style={{
        ...
        >
          ...
          <div>
            ...
            <div style={{ width: "48px", height: "4px", background: "#C2B291", marginBottom: "16px" }} />

            <h3 style={{ fontFamily: "var(--font-inter, Inter, system-ui, sans-serif)", fontWeight: 600, fontSize: "16px", lineHeight: "24px", color: "#000000", margin: "0 0 12px 0" }}>
              Information You Provide
            </h3>

            <p style={{ fontFamily: "var(--font-inter, Inter, system-ui, sans-serif)", fontWeight: 600, fontSize: "14px", lineHeight: "22px", color: "#000000", margin: "0 0 8px 0" }}>
              Account Information
            </p>
            <ul style={{ fontFamily: "var(--font-inter, Inter, system-ui, sans-serif)", fontWeight: 200, fontSize: "14px", lineHeight: "22px", color: "#000000", margin: "0 0 12px 0", paddingLeft: "20px" }}>
            ...
            <ul style={{ fontFamily: "var(--font-inter, Inter, system-ui, sans-serif)", fontWeight: 200, fontSize: "14px", lineHeight: "22px", color: "#000000", margin: "0 0 16px 0", paddingLeft: "20px" }}>
            ...
            <p style={{ fontFamily: "var(--font-inter, Inter, system-ui, sans-serif)", fontWeight: 200, fontSize: "14px", lineHeight: "22px", color: "#000000", margin: "0 0 8px 0" }}>
            ...
            <ul style={{ fontFamily: "var(--font-inter, Inter, system-ui, sans-serif)", fontWeight: 200, fontSize: "14px", lineHeight: "22px", color: "#000000", margin: "0 0 8px 0", paddingLeft: "20px" }}>
              <li>Feature usage patterns</li>
              <li>Navigation flows</li>
              <li>Error reports and crash data</li>
              <li>Performance metrics</li>
            </ul>
            <p style={{ fontFamily: "var(--font-inter, Inter, system-ui, sans-serif)", fontWeight: 200, fontSize: "14px", lineHeight: "22px", color: "#000000", margin: "0" }}>
          ...
          <div>
            <h2 style={{ fontFamily: "var(--font-inter, Inter, system-ui, sans-serif)", fontWeight: 700, fontSize: "20px", lineHeight: "24px", color: "#000000", margin: "0 0 8px 0" }}>
              How We Use Your Information
            </h2>
            <div style={{ width: "48px", height: "4px", background: "#C2B291", marginBottom: "16px" }} />

            <p style={{ fontFamily: "var(--font-inter, Inter, system-ui, sans-serif)", fontWeight: 200, fontSize: "14px", lineHeight: "22px", color: "#000000", margin: "0 0 12px 0" }}>
            ...
            <ul style={{ fontFamily: "var(--font-inter, Inter, system-ui, sans-serif)", fontWeight: 200, fontSize: "14px", lineHeight: "22px", color: "#000000", margin: "0 0 16px 0", paddingLeft: "20px" }}>
              ...
              <li><strong>Communicate With You:</strong> Send important updates about the Service</li>
            ...
            <ul style={{ fontFamily: "var(--font-inter, Inter, system-ui, sans-serif)", fontWeight: 200, fontSize: "14px", lineHeight: "22px", color: "#000000", margin: "0", paddingLeft: "20px" }}>
          ...
          <div>
            ...
            <p style={{ fontFamily: "var(--font-inter, Inter, system-ui, sans-serif)", fontWeight: 200, fontSize: "14px", lineHeight: "22px", color: "#000000", margin: "0 0 16px 0" }}>
            ...
            <p style={{ fontFamily: "var(--font-inter, Inter, system-ui, sans-serif)", fontWeight: 200, fontSize: "14px", lineHeight: "22px", color: "#000000", margin: "0" }}>
              When you delete your account, we remove your personal data within 30 days, except where retention is required by law or for legitimate business purposes.
            </p>
          </div>
          ...
          <div>
            ...
            <p style={{ fontFamily: "var(--font-inter, Inter, system-ui, sans-serif)", fontWeight: 600, fontSize: "14px", lineHeight: "22px", color: "#000000", margin: "0 0 8px 0" }}>Access & Portability</p>
            <p style={{ fontFamily: "var(--font-inter, Inter, system-ui, sans-serif)", fontWeight: 200, fontSize: "14px", lineHeight: "22px", color: "#000000", margin: "0 0 12px 0" }}>
            ...
            <p style={{ fontFamily: "var(--font-inter, Inter, system-ui, sans-serif)", fontWeight: 600, fontSize: "14px", lineHeight: "22px", color: "#000000", margin: "0 0 8px 0" }}>Correction</p>
            <p style={{ fontFamily: "var(--font-inter, Inter, system-ui, sans-serif)", fontWeight: 200, fontSize: "14px", lineHeight: "22px", color: "#000000", margin: "0 0 12px 0" }}>
              You can update your account information and preferences at any time within the app.
            </p>

            <p style={{ fontFamily: "var(--font-inter, Inter, system-ui, sans-serif)", fontWeight: 600, fontSize: "14px", lineHeight: "22px", color: "#000000", margin: "0 0 8px 0" }}>Deletion</p>
            <p style={{ fontFamily: "var(--font-inter, Inter, system-ui, sans-serif)", fontWeight: 200, fontSize: "14px", lineHeight: "22px", color: "#000000", margin: "0 0 12px 0" }}>
              You can delete individual bookmarks, highlights, and notes at any time. To delete your entire account, contact us at <a href="mailto:versematehelp@gmail.com" style={{ color: "#C2B291" }}>versematehelp@gmail.com</a>.
            </p>

            <p style={{ fontFamily: "var(--font-inter, Inter, system-ui, sans-serif)", fontWeight: 600, fontSize: "14px", lineHeight: "22px", color: "#000000", margin: "0 0 8px 0" }}>Opt-Out of Analytics</p>
            <p style={{ fontFamily: "var(--font-inter, Inter, system-ui, sans-serif)", fontWeight: 200, fontSize: "14px", lineHeight: "22px", color: "#000000", margin: "0 0 12px 0" }}>
              You can opt out of analytics tracking in the app settings.
            </p>

            <p style={{ fontFamily: "var(--font-inter, Inter, system-ui, sans-serif)", fontWeight: 600, fontSize: "14px", lineHeight: "22px", color: "#000000", margin: "0 0 8px 0" }}>Do Not Sell My Personal Information</p>
            <p style={{ fontFamily: "var(--font-inter, Inter, system-ui, sans-serif)", fontWeight: 200, fontSize: "14px", lineHeight: "22px", color: "#000000", margin: "0 0 16px 0" }}>
              We do not sell your personal information. Ever.
            </p>

            <h3 style={{ fontFamily: "var(--font-inter, Inter, system-ui, sans-serif)", fontWeight: 600, fontSize: "16px", lineHeight: "24px", color: "#000000", margin: "0 0 8px 0" }}>For California Residents (CCPA)</h3>
            <p style={{ fontFamily: "var(--font-inter, Inter, system-ui, sans-serif)", fontWeight: 200, fontSize: "14px", lineHeight: "22px", color: "#000000", margin: "0 0 12px 0" }}>
            ...
            <h3 style={{ fontFamily: "var(--font-inter, Inter, system-ui, sans-serif)", fontWeight: 600, fontSize: "16px", lineHeight: "24px", color: "#000000", margin: "0 0 8px 0" }}>For European Users (GDPR)</h3>
            <p style={{ fontFamily: "var(--font-inter, Inter, system-ui, sans-serif)", fontWeight: 200, fontSize: "14px", lineHeight: "22px", color: "#000000", margin: "0" }}>
              If you are in the European Economic Area, you have rights under the General Data Protection Regulation. Contact us at <a href="mailto:versematehelp@gmail.com" style={{ color: "#C2B291" }}>versematehelp@gmail.com</a> to exercise these rights.
            </p>
          </div>
          ...
          <div>
            ...
            <p style={{ fontFamily: "var(--font-inter, Inter, system-ui, sans-serif)", fontWeight: 200, fontSize: "14px", lineHeight: "22px", color: "#000000", margin: "0" }}>
              If you discover a security vulnerability, please contact us at <a href="mailto:versematehelp@gmail.com" style={{ color: "#C2B291" }}>versematehelp@gmail.com</a>.
            </p>
          </div>
          ...
          <div>
            ...
            <p style={{ fontFamily: "var(--font-inter, Inter, system-ui, sans-serif)", fontWeight: 200, fontSize: "14px", lineHeight: "22px", color: "#000000", margin: "0" }}>
              VerseMate is intended for users aged 13 and older. We do not knowingly collect personal information from children under 13. If you believe a child under 13 has provided us with personal information, please contact us at <a href="mailto:versematehelp@gmail.com" style={{ color: "#C2B291" }}>versematehelp@gmail.com</a>.
            </p>
          </div>
          ...
          <div>
            ...
            <p style={{ fontFamily: "var(--font-inter, Inter, system-ui, sans-serif)", fontStyle: "italic", fontWeight: 200, fontSize: "14px", lineHeight: "22px", color: "#000000", margin: "0" }}>
