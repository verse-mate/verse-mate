...
export default function TabletSupportPage() {
  return (
    <div
      ...
      data-testid="tablet-support-page"
    >
      <Header />
        ...
        >
          ...
          >
            <div style={{ textAlign: "center" }}>
              ...
              <div style={{ width: "64px", height: "4px", background: "#C2B291", margin: "0 auto 24px auto" }} />
              <p
                style={{
                  fontFamily: "var(--font-inter)",
                  fontStyle: "normal",
          ...
          >
            ...
            <div style={{ width: "64px", height: "4px", background: "#C2B291" }} />
            <div
              style={{
                display: "flex",
                flexDirection: "column",
