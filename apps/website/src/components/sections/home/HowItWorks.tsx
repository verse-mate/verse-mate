...
export default function HowItWorks() {
  return (
    <section className="w-full self-stretch bg-light-radial py-12 md:py-16 lg:py-24">
      {/* Content Container - responsive with max width */}
      <div className="mx-auto flex w-full max-w-[1440px] flex-col items-center gap-8 px-6 md:gap-12 md:px-8 lg:gap-16 lg:px-16 xl:px-[120px]">
        {/* Title */}
        <div className="flex flex-row items-center justify-center gap-2 border-b-[6px] border-brand-tan px-0 py-2">
        ...
        <div className="flex w-full max-w-[1200px] flex-col items-start gap-12 p-0 md:gap-16 lg:gap-20">
          ...
          <div className="flex w-full flex-col items-center gap-12 p-0 lg:flex-row lg:items-center lg:gap-16 xl:gap-20">
            ...
            {/* Description */}
            <div className="flex w-full max-w-[414px] flex-1 flex-col items-start gap-6 p-0 md:gap-10 lg:w-1/2 lg:gap-12">
              {/* Summary View */}
              <div className="flex w-full flex-col items-start gap-2 rounded-[20px] p-0">
                ...
                <p className="w-full font-inter text-base font-light leading-6 text-brand-slate md:text-lg md:leading-7 lg:text-2xl lg:leading-8">
          ...
          {/* Text Line */}
          <p className="w-full text-center font-inter text-base font-medium leading-6 text-brand-dark-gray md:text-lg md:leading-7 lg:text-xl lg:leading-8">
